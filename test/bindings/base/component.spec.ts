...
class TestViewModel {}
// template declaration is separate for easier comparison inside the test
const template = "<h1>hello world</h1>";
// register dummy component
registerComponent("test-component", { viewModel: TestViewModel, template });
...
describe("component handler", () => {
	...
	it("should only be able to be applied on HTMLElement", async () => {
		...
		// assert
		expect(applyFn(htmlElement)).resolves.not.toThrow();
